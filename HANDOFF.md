...
*Nächster Schritt: Product Manual ist fertig (`Diagnose & Sprints/TRAIN-Product-Manual.md`,
2026-08-15). Nutzer möchte den Test-Katalog für die manuelle Vor-Betatest-Prüfung
bewusst noch zurückstellen, bis wirklich keine Änderungen mehr anstehen — Runde 21
(Kurzartikel-Feature, B245) lief währenddessen bereits dazwischen. Sobald keine
weiteren Change-Runden mehr offen sind: Test-Katalog auf dem dann aktuellen Stand
erstellen, erst danach Betatest-Personen-Akquise (Phase G). Phase G selbst
